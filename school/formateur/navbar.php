...
<head>
    ...
    <link rel="shortcut icon" href="../apprenant/images/logo.png" type="image/x-icon"  height="9px">
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto">
        ...
        <li class='nav-item'><a href = 'profile.php'><img src='../apprenant/images/user.png' alt='profile' ></a></li>
